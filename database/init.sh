...
mysql --user='mifranco' --password='Aideebe4esooDuqu' --database="mifranco" --default-character-set=utf8 --show-warnings --execute="source create_tables_and_insert_data.sql"